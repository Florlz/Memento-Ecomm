...
// Add an event listener to all links with href attributes pointing to sections on the same page
...
// Call the function to update the username and avatar on page load
updateUsername();
